...
export default function DummyNotes({
  ...
  return (
    <div
      ...
      className="relative flex h-[20rem] w-[20rem] rounded-xl bg-white shadow-lg dark:bg-neutral-900"
    >
      ...
      <div className="w-full p-4">
        <h2 className="text-center font-medium text-neutral-800 dark:text-neutral-100">
          Notes
        </h2>
